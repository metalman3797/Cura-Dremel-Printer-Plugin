...
|--------------|------------------------------------------------------------------------|
4.4 through 4.8 | [version 0.6.4](https://github.com/timmehtimmeh/Cura-Dremel-3D20-Plugin/releases/tag/0.6.4)
