...
**Note - This plugin currently crashes the just-released Cura 3.3 - I'm aware of the issue and will fix it as I get time - until then please stay with Cura 3.2.1 - When this plugin is fully compatible with Cura 3.3 I'll take this message away and close the issue that I'm using to track it [here](https://github.com/timmehtimmeh/Cura-Dremel-3D20-Plugin/issues/21)**
